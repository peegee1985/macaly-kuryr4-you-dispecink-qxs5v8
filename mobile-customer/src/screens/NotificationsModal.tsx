...
const notificationIcon: Record<CustomerNotification["type"], "cube-outline" | "person-add-outline" | "document-text-outline" | "checkmark-circle-outline" | "information-circle-outline"> = {
...
const notificationColor: Record<CustomerNotification["type"], string> = {
